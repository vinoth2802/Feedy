    ...
    return (
        <div className="dialog-overlay">
            <div className="dialog-box shadow-lg rounded-4 p-4 position-relative" style={{ width: '600px', background: 'white' }}>
                ...
                <h3 className='mb-4 fw-semibold text-primary' style={{ fontSize: '1.25rem' }}>Add New Course</h3>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-center mt-4">
                        <button type="submit" className="btn btn-primary px-4">Add Course</button>
                    </div>
                </form>
